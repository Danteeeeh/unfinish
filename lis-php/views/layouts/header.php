...
<head>
    ...
    <style>
        /* Enhanced LIS Styling with Dark Mode */
        :root {
        ...
        [data-theme="dark"] {
            ...
            --lab-gradient: linear-gradient(135deg, #9f7aea 0%, #667eea 100%);
...
<body>
    ...
    <header class="top-header">
        <div class="header-left">
            ...
            <div class="brand">
                ...
                <span class="brand-module">LIS</span>
            </div>
        </div>
        <div class="header-right">
            <a href="/id-login-admin/dashboard.php" class="btn btn-primary btn-sm">🏠 Main Dashboard</a>
            <span class="user-name"><i class="fas fa-user-circle"></i> <?php echo getCurrentUser()['full_name']; ?></span>
    ...
    <aside class="sidebar" id="sidebar">
        <nav class="sidebar-nav">
            <a href="index.php?route=dashboard" class="nav-item active">
                <i class="fas fa-home"></i>
                <span>Dashboard</span>
            </a>
            <a href="index.php?route=samples/list" class="nav-item">
                <i class="fas fa-vial"></i>
                <span>Sample</span>
            </a>
            <a href="index.php?route=tests/pending" class="nav-item">
                <i class="fas fa-clipboard-list"></i>
                <span>Test orders</span>
            </a>
            <a href="index.php?route=tests/results" class="nav-item">
            ...
            <a href="index.php?route=admin" class="nav-item">
