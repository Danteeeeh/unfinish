...
class DashboardController extends BaseController {
    ...
    public function index() {
        try {
            ...
            $stats = $this->getStats();
            $recentStudies = $this->study->getRecent();
    ...
    private function testDatabaseConnection() {
        try {
            ...
            $requiredTables = ['patients', 'ris_exams', 'ris_equipment'];
    ...
    private function renderErrorPage($error) {
        ...
        <head>
            ...
            <title>RIS - Connection Error</title>
            <link rel="preconnect" href="https://fonts.googleapis.com">
            <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
            <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">
            <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
            <style>
                /* Enhanced RIS Error Styling with LIS Design Pattern */
                :root {
        ...
        <body>
            <div class="error-container">
                <h1 class="error-title"><i class="fas fa-exclamation-triangle"></i> RIS System Error</h1>
    ...
    private function getStats() {
        try {
            ...
            // Studies today
            $stmt = $conn->prepare("SELECT COUNT(*) as count FROM ris_exams WHERE DATE(exam_date) = ?");
            $stmt->execute([$today]);
            $studiesToday = $stmt->fetch()['count'];

            // Available modalities
            $stmt = $conn->query("SELECT COUNT(*) as count FROM ris_equipment WHERE status = 'operational'");
            $availableModalities = $stmt->fetch()['count'];

            return [
                'total_patients' => $totalPatients,
                'studies_today' => $studiesToday,
